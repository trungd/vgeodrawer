========================================================================
    STATIC LIBRARY : VGControls Project Overview
========================================================================

AppWizard has created this VGControls library project for you. 

This file contains a summary of what you will find in each of the files that
make up your VGControls application.
...
StdAfx.h, StdAfx.cpp
    ...
    named VGControls.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "VGControls.rc" and a "VGControls.h" that 

...
class CParamTooltipCtrl : public CWnd
{
	...
	struct METHOD {
		...
		METHOD(const CString& sName, const vector<CString>& setParams, const CString& description)
			: m_sName(sName)
...
public:
	...
	void AddMethod(const CString& sMethod, const vector<CString>& setParams, const CString& desc);
